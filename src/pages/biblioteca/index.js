...
const Biblioteca = ({ data }) => {
  ...
  <div className="text-center max-w-xl mx-auto">
      <h1 className="text-6xl md:text-7xl font-bold mb-24 pt-12 text-gray-600">Biblioteca Digital</h1> </div>
                <div className="mt-6 sm:px-28 px-0">
                  <div className=" bg-white rounded-lg flex sm:flex-row flex-col sm:space-x-5 space-x-0 sm:space-y-0 space-y-5 items-center sm:text-left text-center mb-4">
                    <a
                      href="#"
...
<h1 class="text-gray-700 font-bold ">{post.frontmatter.autor}</h1>
