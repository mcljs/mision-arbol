...
<div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
	...
	<div className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-3xl bg-white opacity-85 mx-6 lg:mx-0">
      ...
      <p className="pt-8 text-sm"><span>CARACTERISTICAS FÍSICAS: </span>ES UN ÁRBOL DE GRAN PARTE DEL NORTE DE SUDAMÉRICA, EN LA REGIÓN DE LAS GUAYANAS, DE VENEZUELA, COLOMBIA, GUYANA. A VECES EN EL MERCADO INTERNACIONAL SE LO NOMBRA COMO PARAGUAY LIGNUM VITAE YA QUE SUS PROPIEDADES Y USOS SON SIMILARES AL GUAYACÁN, ÁRBOL DEL GÉNERO GUAIACUM.

CRECE EN BORDES DE CARRETERAS, CAMINOS Y RÍOS, Y EN EL INTERIOR DE BOSQUES SECOS, SUBXEROFÍTICOS Y ESPINOSOS.
</p>
 <p className="pt-8 text-sm"><span>PROPIEDADES: </span>MUY USADO EN CONSTRUCCIONES CIVILES Y EN NAVALES, TORNERÍA, ELABORACIÓN DE DURMIENTES DE FERROCARRIL. ES PLANTA ORNAMENTAL EN JARDINERÍA. LA MADERA DEBE UTILIZARSE RECIÉN CORTADA, PUESTO QUE AL SECARSE SE PONE EXTREMADAMENTE DURA Y YA NO ES APROVECHABLE.
