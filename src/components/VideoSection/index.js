...
const VideoSection = (  ) => (
  <>
    ...
    <div className="video-content space-y-2 mb-28">
      <h1 className="text-4xl sm:text-6xl font-black leading-tight text-yellow-1100">Misión <span className="text-yellow-1100">Árbol</span></h1>
    ...
    <Link to="https://www.facebook.com/Fundamiarbolven" aria-label='Facebook'>
      <button className="px-5 sm:px-7 py-2 rounded-full text-white bg-yellow-1100 hover:bg-green-600 font-semibold  xl:mr-2 "> <FaFacebook className="w-4 sm:w-6 h-6" />
</button></Link>
    
 <Link to='https://twitter.com/misionarbolven' aria-label='Twitter'>
      <button className="px-5 sm:px-7 py-2 rounded-full text-white bg-yellow-1100 hover:bg-green-600 font-semibold ">   <FaTwitter className="w-4 sm:w-6 h-6"/></button></Link>

 <Link to='https://www.instagram.com/fundamiarbolven/' aria-label='Instagram'>
      <button className="px-5 sm:px-7 py-2 rounded-full text-white bg-yellow-1100 hover:bg-green-600 font-semibold  "><FaInstagram  className="w-4 sm:w-6 h-6"/>
</button></Link>
