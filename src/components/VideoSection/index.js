...
const VideoSection = (  ) => (
  <>
    ...
    <Link to="https://www.facebook.com/Fundamiarbolven" aria-label='Facebook'>
      <button className="px-5 sm:px-7 py-2 rounded-full text-white bg-[#455e29] font-semibold hover:bg-[#7daa49] focus:bg-indigo-600 xl:mr-2 "> <FaFacebook className="w-4 sm:w-6 h-6" />
</button></Link>
    
 <Link to='https://twitter.com/misionarbolven' aria-label='Twitter'>
      <button className="px-5 sm:px-7 py-2 rounded-full text-white bg-[#455e29] font-semibold hover:bg-[#7daa49]">   <FaTwitter className="w-4 sm:w-6 h-6"/></button></Link>

 <Link to='https://www.instagram.com/fundamiarbolven/' aria-label='Instagram'>
      <button className="px-5 sm:px-7 py-2 rounded-full text-white bg-[#455e29] font-semibold hover:bg-[#7daa49] "><FaInstagram  className="w-4 sm:w-6 h-6"/>
</button></Link>
