      ...
      <Section>
        <Container>
          ...
          <ColumnRight reverse={reverse}>
            <StaticImage src="https://res.cloudinary.com/dk5bvgq20/image/upload/c_scale,h_446,q_10/v1616809252/assets/image-5_rmtsez.webp" formats={["auto", "webp", "avif"]} alt="home" /> 
          </ColumnRight>
        </Container>
      </Section>
  );
