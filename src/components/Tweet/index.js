...
const isSSR = typeof window === "undefined"
 ...
 <React.Suspense fallback={ <DelayedFallback /> }>
    ...
    <div className="flex justify-between mb-4 xl:col-start-3 xl:col-end-8">
      <h1 className="text-white text-center text-2xl xl:text-3xl"><strong>Twitter</strong></h1>
    </div>
    ...
    <div className="w-full mt-10 xl:mt-9 xl:col-start-6 xl:col-end-11 xl:ml-6">
      <span className="text-white text-center text-2xl xl:text-2xl ">Cuenta Oficial Fundación Misión Árbol</span>
