  ...
  <div id="card" className="">
    ...
    <div className="container w-100 lg:w-4/5 mx-auto flex flex-col">
        ...
        <div className="h-64 w-auto md:w-1/2">
          ...
          <h3 className="font-semibold text-lg leading-tight dark:text-white"> Edición 005 del periódico NOTIÁRBOL resalta el desarrollo de la jornada de reforestación en los espacios del Jardín Botánico junto al MINEC, MPPEY y MPPCPS.</h3>
