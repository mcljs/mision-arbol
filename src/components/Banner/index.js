  ...
  <div id="card" className="">
    ...
    <div className="container w-100 lg:w-4/5 mx-auto flex flex-col">
        ...
        <div className="h-64 w-auto md:w-1/2">
          <StaticImage className="inset-0 h-full w-full object-cover object-center" src="../../images/patria_portada.png" />
        </div>
               <div className="w-full py-10 px-6 text-gray-800 flex flex-col justify-between">

          <h3 className="font-semibold text-lg leading-tight "> Edición 273 del periódico 4F resalta rol fundamental de la nueva AN para la recuperación de la economía en Venezuela </h3>
          <p className="mt-2">
