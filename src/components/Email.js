...
const Email = (  ) => {
    ...
    <section id="call-to-action" className=" relative overflow-hidden bg-yellow-1100 focus:bg-indigo-600 bg-opacity-90 call-to-action">
          ...
          <div className="w-full lg:w-1/2">
            <div className="py-32 mx-auto text-center call-action-content">
              ...
              <form className="relative w-5/6 mx-auto md:w-2/3 call-newsletter">
                ...
                <button className="absolute top-0 right-0 px-6 py-2 mt-1 mr-1 font-bold text-white duration-300 bg-yellow-1100 rounded-full hover:bg-green-500">→</button>
              </form>
            </div>
          </div>
